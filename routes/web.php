...
use App\Http\Controllers\Admin\VisibilityToggleController;
...
Route::middleware(['auth'])->prefix('administration')->name('admin.')->group(function () {
    ...
    Route::controller(SubCategorieController::class)->name('sub-categories.')->prefix('sub-categories')->group(function () {
        Route::get('sous-categorie', 'index')->name('index');
        Route::get('create', 'create')->name('create');
        Route::post('sous-categorie/create', 'store')->name('store');
        Route::get('{subCategorie}', 'show')->name('show');
        Route::get('{subCategorie}/edit', 'edit')->name('edit');
        Route::put('{subCategorie}/modifier', 'update')->name('update');
        Route::delete('{subCategorie}/supprimer', 'destroy')->name('delete');
        Route::get('by-category/{categoryId}', 'getByCategory')->name('by-category');
    });
