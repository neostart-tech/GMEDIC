...
@section('content')
        ...
        <div class="hero-slider-container">
            ...
            <div class="hero-slide-wrapper active">
                            ...
                            <div class="text-overlay-content">
                                <div class="content-inner">
                                    ...
                                    <h1 class="main-hero-title">
                                        {{ __('Bienvenue chez') }} <br> <span
                                            class="title-accent">{{ env('APP_NAME') }}</span>
                                    </h1>
                ...
                <div class="slide-image-container">
                    <img src="{{ asset('assets/images/slider/image-slide2.jpg') }}" alt="Présentation {{ env('APP_NAME') }}"
            ...
            <div class="hero-slide-wrapper">
                ...
                <div class="slide-image-container">
                    <img src="{{ asset('assets/images/slider/image-slide3.jpg') }}"
                        alt="Équipements médicaux haute performance" class="hero-background-image">
                    <div class="image-overlay-gradient"></div>
                </div>
            </div>
            ...
            <div class="hero-slide-wrapper">
                ...
                <div class="slide-image-container">
                    <img src="{{ asset('assets/images/slider/image-slide1.jpg') }}"
                        alt="Support et accompagnement personnalisé" class="hero-background-image">
                    <div class="image-overlay-gradient"></div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                ...
                                <div class="card-overlay">
                                    <button class="view-btn"
                                        onclick="displayShowModal({{ $article }}, '{{ Storage::url($article->article_image) }}')">
                            ...
                            <div class="card-content">
                                <h3 class="product-name">
                                    {{ $article->getTranslation('article_name', app()->getLocale()) }}</h3>
            ...
            @else
                <div class="empty-state">
                    ...
                    <p>{{ __('Notre catalogue de produits est actuellement en cours de construction. Revenez bientôt pour découvrir nos dernières innovations.') }}
                    </p>
                </div>
            @endif
    ...
    <section class="values-section" style="background:white">
        <div class="container">
            <div class="section-header center">
                ...
                <div cl ass="section-divider center"></div>
            </div>
                        ...
                        <div class="about-slider">
                            ...
                            <div class="about-slide active">
                                <div class="slide-image-wrapper">
                                    <img src="{{ asset('assets/images/slider/image-slide1.jpg') }}"
                                        alt="Échographie médicale" loading="lazy">
                            ...
                            <div class="about-slide">
                                <div class="slide-image-wrapper">
                                    <img src="{{ asset('assets/images/slider/image-slide2.jpg') }}"
                                        alt="Tensiomètre numérique" loading="lazy">
                            ...
                            <div class="about-slide">
                                <div class="slide-image-wrapper">
                                    <img src="{{ asset('assets/images/slider/image-slide3.jpg') }}"
                                        alt="Appareil CPAP/PPC" loading="lazy">
    ...
    <style>
        ...
        * {
        ...
        .value-shape.accessibility {
            background: #f59e0b;
        }

        .value-shape.engagement {
            background: #ef4444;
        }
    ...
    `).join('');
        ...
        function getDefaultFeatures(article) {
            ...
            const baseFeatures = [{
                    ...
                    text: 'Certification CE médicale'
                },
                {
                    icon: 'fas fa-shield-alt',
                    text: 'Normes européennes'
                },
                {
                    icon: 'fas fa-tools',
            ...
            if (article.article_name?.toLowerCase().includes('cpap') || article.article_name?.toLowerCase().includes(
                'ppc')) {
                baseFeatures.push({
                    icon: 'fas fa-wind',
                    text: 'Thérapie pression positive'
                }, {
                    icon: 'fas fa-moon',
                    text: 'Mode confort nuit'
                }, {
                    icon: 'fas fa-chart-line',
                    text: 'Suivi des données'
                }, {
                    icon: 'fas fa-volume-mute',
                    text: 'Silencieux < 30dB'
                });
            }
