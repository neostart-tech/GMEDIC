...
<div class="mobile-filters">
    ...
    <div class="filters-dropdown-content" id="filtersDropdownContent">
        ...
        <div class="filter-section">
            ...
            <input type="range" id="priceRangeMobile" min="0" max="1000000" value="1000000" step="1000" oninput="updatePriceDisplay()">
    ...
    <main class="products-main">
        ...
        <div class="products-content">
            ...
            <div class="pagination-container" id="paginationContainer" style="display: none;">
                <button class="pagination-btn" id="prevPage" onclick="changePage(currentPage - 1)">
                    <i class="fas fa-chevron-left"></i>
                    {{ __('precedent') }}
                </button>
                ...
                <button class="pagination-btn" id="nextPage" onclick="changePage(currentPage + 1)">
                    {{ __('suivant') }}
                    <i class="fas fa-chevron-right"></i>
                </button>
            </div>
...
<script>
    ...
    function applyFilters() {
        ...
        currentPage = 1; // Retour à la première page lors du filtrage
        displayProducts();
    }
    ...
    function displayProducts() {
        ...
        count.textContent = `${filteredProducts.length} {{ __('equipements_trouves') }}`;
    ...
    function updatePagination() {
        ...
        if (startPage > 1) {
            ...
            if (startPage > 2) {
                pagesHTML += `<div class="page-number" style="border: none; background: transparent;">...</div>`;
            }
        }
        ...
        infoContainer.textContent = `${startItem}-${endItem} sur ${filteredProducts.length}`;
    }
    ...
    function resetFilters() {
        ...
        priceInputs.forEach(input => input.value = 1000000);
